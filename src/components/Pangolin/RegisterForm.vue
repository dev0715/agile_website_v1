  ...
  <div id="contact" class="margin-bottom40">
    <div class="container">
      <div class="post-heading-center" style="margin-top: 30px">
        <h2>Try Pangolin Risk Free for 14 Days</h2>
      </div>
      ...
      <div class="alert alert-success alert-dismissible show" role="alert" v-if="success">
        ...
        <div style="font-size: 20px">
          Thanks for your request for evaluating Pangolin. Our support team will send you an evaluation license along with resources for getting started within 24 hours. If you have any questions, please don't hesitate to
      ...
      <div class="row register-pannel" id="register-pannel-id">
        ...
        <div class="col-md-8 py-5 border-pangolin">
          <div class="container-fluid mx-3">
            ...
            <div class="row px-3">
              <div class="container-fluid mb-30 mx-3">
                <input type="button" name="submit" value="Register" class="reg_btn dragonfly_trial_submit" title="Dragonfly Trial Submit" @click="registerUser()" />
              </div>
            </div>
          </div>
        </div>
