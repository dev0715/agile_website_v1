  ...
  <div id="contact" class="margin-bottom40">
    <div class="container">
      ...
      <div class="row register-pannel" id="register-pannel-id">
        ...
        <div class="col-md-8 py-5 border-dragonfly">
              ...
              <form method="post" class="divi-affa-form-contact" id="divi-register-form" enctype="multipart/form-data">
                <div class="container-fluid">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 px-3">
                      <div class="form-group">
                        <VueRecaptcha class="g-recaptcha" ref="recaptcha" @verify="onVerify" @expired="onExpired" :sitekey="'6Ldz7n8aAAAAANzpTXO1uDZrV8AzAhCUtM9ptsPz'"> </VueRecaptcha>
                      </div>
                    </div>
                  </div>
                </div>
