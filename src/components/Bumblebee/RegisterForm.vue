    ...
    <div class="container">
      ...
      <div class="alert alert-success alert-dismissible show" role="alert" v-if="success">
        ...
        <div style="font-size: 20px">
          Thanks for your request for evaluating Bumblebee. Our support team will send you an evaluation license along with resources for getting started within 24 hours. If you have any questions, please don't hesitate to
      ...
      <div class="row register-pannel" id="register-pannel-id">
        ...
        <div class="col-md-8 py-5 border-bumblebee">
          <div class="container-fluid mx-3">
                    ...
                    <div class="col-md-6 col-lg-6 px-3">
                      <div class="form-group">
                        ...
                        <select id="country" name="r_country" class="form-control" v-model="r_country">
                          <option v-for="item in country_options" v-bind:value="item.value" v-bind:key="item.text">
                            {{ item.text }}
                          </option>
                        </select>
                      </div>
            ...
            <div class="row px-3">
              <div class="container-fluid mb-30 mx-3">
                <input type="button" name="submit" value="Register" class="reg_btn submit" title="Bumblebee Trial Submit" @click="registerUser()" />
              </div>
            </div>
          </div>
          <!-- .row end -->
